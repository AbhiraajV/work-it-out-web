...
function AutoUpdatingWorkoutName({ workouts }: Props) {
  ...
  return (
    <div className="flex flex-col bg-white border-b-4 border-black md:flex-row justify-between items-start text-xl mr-[1vw] md:ml-0 font-semibold  text-black py-2 px-3 rounded-sm mb-10">
      {workouts && (
        <>
